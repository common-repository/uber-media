...
function add_uber_media_500px( $sources ) {
	$sources['500px'] = array(	'source' => '500px',
								'core' => true );
	return $sources;
}
...
function mmp_settings_500px($wpsf_ubermedia_settings) {
	...
	$fields[] = 	array(
					            'id' => '500px-license',
					            'title' => __( '500px License Options','uber-media' ),
					            'desc' => __( 'Select the license type of images returned from 500px','uber-media' ),
					            'type' => 'select',
					            'choices' => $choices,
					            'std' => '-1'
					        );
